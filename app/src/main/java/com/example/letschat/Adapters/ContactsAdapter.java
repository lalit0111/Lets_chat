...
public class ContactsAdapter extends RecyclerView.Adapter<ContactsAdapter.ViewHolder> implements Filterable {
    ...
    List<contactDetails> contactsDetailsAll;
    ...
    public ContactsAdapter(List<contactDetails> contactDetailsList) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        final contactDetails contactsDetails = contactDetailsList.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charSequence.toString().isEmpty()) {
                    ...
                    for (contactDetails var : contactsDetailsAll) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                ...
                contactDetailsList.addAll((Collection<? extends contactDetails>) filterResults.values);
